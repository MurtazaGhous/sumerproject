...
public class GameLogic {
    ...
    private void initializeScores() {
        ...
        gameResult = new Text("", 35, 350, 350, "BLUE");
    ...
    private boolean isInGoal(Ball puck, Rectangle goal) {
        // Calculate the edges of the puck and goal
        double puckX = puck.getXPosition();
        double puckY = puck.getYPosition();
        ...
        return puckX > goalLeft && puckX < goalRight && puckY > goalTop && puckY < goalBottom;
    }
